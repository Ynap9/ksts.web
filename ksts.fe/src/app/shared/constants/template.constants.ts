...
/**
 * Màu mực dùng cho bản xem trước. BE nong nét bằng cách vẽ chồng chính ảnh nên giữ đúng màu mực thật, còn
 * CSS drop-shadow bắt buộc phải nêu một màu — lấy đúng màu bản dựng gốc dùng cho ảnh chữ ký quét. Hệ quả:
 * chữ ký mực đen kéo thanh lên cao sẽ thấy quầng hơi ngả xanh ở bản xem trước, bản in ra thì không.
 */
