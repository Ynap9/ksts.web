...
using ksts.plugin.external.Tray.Implements;
...
namespace ksts.plugin.api
{
    internal static class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            // Một file exe đóng hai vai. Dựng tay ba service này thay vì qua DI vì phải phân vai XONG rồi mới
            // biết có cần web host hay không.
