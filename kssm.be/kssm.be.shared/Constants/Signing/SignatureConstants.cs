namespace kssm.be.shared.Constants.Signing
{
    ...
    /// Khác <see cref="CertificateConstants"/>: file này ghim CA để dựng chuỗi tin cậy, file kia nhận diện chỗ
    /// giữ khoá của chứng thư trong kho.
    /// </summary>
    public static class SignatureConstants
    {
        // Thư mục con cạnh app chứa toàn bộ chứng thư CA đã ghim (kssm.be.api/Cert -> copy ra output).
