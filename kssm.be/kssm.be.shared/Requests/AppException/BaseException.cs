namespace kssm.be.shared.Requests.AppException
{
    public class BaseException : System.Exception
    {
        ...
        /// ex.Message — log, lý do lỗi của từng bản ghi. Bỏ trống thì những chỗ đó nhận đúng một câu vô nghĩa
        /// "Exception of type ... was thrown", đọc log không biết hỏng vì cái gì.
        /// </summary>
