...
namespace kssm.be.external.KySo.Certificates.Interfaces
{
    /// <summary>
    ...
    ///
    /// Tách riêng khỏi ICertificateProvider vì lý do BẢO MẬT, không phải cho gọn: khi chứng thư đến từ plugin
