...
namespace kssm.be.external.KySo.Certificates.Implements
{
    /// <summary>
...
#pragma warning restore SYSLIB0028
                    ...
                    var isHardwareKey = !string.IsNullOrWhiteSpace(keyProvider)
                        && !CertificateConstants.SoftwareKeyProviderMarkers.Any(marker =>
                            keyProvider.Contains(marker, StringComparison.OrdinalIgnoreCase))
                        && CertificateConstants.HardwareKeyProviderMarkers.Any(marker =>
                            keyProvider.Contains(marker, StringComparison.OrdinalIgnoreCase));
